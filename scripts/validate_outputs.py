...
REQUIRED_FILES = {
    ...
    "performance_learning": DATA_DIR / "performance_learning.csv",
    "data_quality_report": DATA_DIR / "data_quality_report.csv",
    "signals": DATA_DIR / "signals.csv",
    "market_timing": DATA_DIR / "market_timing.csv",
